...
public class MatrixController {
	...
	@GetMapping(RestClient.STATIONS)
	public ResponseEntity<Response<Set<Station>>> getStations(String login, String password, String locale) {
		return client.getStations(login, password, locale, true);
	}
